    ...
    <section id="shop" className="py-20 md:py-32 bg-secondary/30">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          {/* Category Tabs */}
          <div className="flex items-center gap-1 bg-background/50 p-1">
        ...
        <motion.div
          ...
          className="grid grid-cols-3 gap-4 mt-20 pt-12 border-t border-border"
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="text-2xl md:text-4xl font-serif">{stat.value}</div>
